...
PAGES = [
    ...
    #{
        ...
        #"url": "https://builders.intel.com/communities/network",
...
def test_staticized_pages(browser_page, page_data):
  ...
  #  page.wait_for_load_state("networkidle", timeout=90000)
    ...
    print("\nVisible text check:")
    if missing_visible:
        print(f"FAIL: Missing visible text: {missing_visible}")
    else:
        print("PASS: All expected text is visible.")

    print("\nHTML source check:")
    if missing_source:
        print(f"FAIL: Missing text in source: {missing_source}")
    else:
    ...
    if suspect_requests:
        print("\nFAIL: Suspect content/API requests:")
